...
export default function ResumePortfolioSite() {
  ...
  return (
    <div className="min-h-screen bg-[#d0d0cb] bg-[radial-gradient(circle_at_top_left,_rgba(255,255,255,0.35),_transparent_38%),radial-gradient(circle_at_bottom_right,_rgba(255,255,255,0.14),_transparent_34%),linear-gradient(180deg,_#d8d8d3_0%,_#c9c9c4_48%,_#c1c1bb_100%)] text-[#2a2a27]">
