  ...
  const experiences = [
    {
      ...
      description: "Я занимался продвижением проектов правительства Москвы в СМИ, блогах и социальных сетях. Готовил справочные материалы и темники для городского руководства. Важной частью моей работы была популяризация контента Мэрии Москвы в Telegram, MAX, Дзен и на других крупных площадках. Курировал сферы транспорта, образования, интернет-технологий, а также все городские выборы.",
    },
    {
      period: "2018 — 2020",
