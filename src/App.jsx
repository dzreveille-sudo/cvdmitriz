...
export default function ResumePortfolioSite() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f7f5] text-[#1f1f1f] scroll-smooth">
      ...
      <main>
        <section
          id="about"
          className="mx-auto grid min-h-[78vh] max-w-7xl grid-cols-1 gap-6 px-6 py-10 lg:grid-cols-[1.45fr_0.75fr] lg:px-10 lg:py-14"
        >
          <div className="flex flex-col justify-center rounded-[2rem] border border-[#d9d9d6] bg-white p-7 shadow-sm lg:p-10">
            <div>
          ...
          <div className="flex items-start justify-center lg:justify-end">
            <div className="overflow-hidden rounded-full border border-[#d9d9d6] bg-white p-3 shadow-sm">
              <img
                src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=1200&q=80"
                alt="Портрет"
                className="h-[220px] w-[220px] rounded-full object-cover md:h-[260px] md:w-[260px]"
        ...
        <section className="mx-auto max-w-7xl px-6 pb-8 lg:px-10">
          <div className="rounded-[2rem] border border-[#d9d9d6] bg-white p-6 shadow-sm lg:p-8">
            <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              <div>
            ...
            <div className="grid gap-4">
              {experiences.map((item, index) => (
                <div
                  key={index}
                  className="grid gap-2 rounded-[1.4rem] border border-[#d9d9d6] p-4 md:grid-cols-[140px_1fr] md:gap-4 md:p-5"
                >
                  <div className="text-sm text-[#666]">{item.period}</div>
                  <div>
                    <h3 className="text-lg font-medium">
        ...
        >
          <div className="rounded-[2rem] border border-[#d9d9d6] bg-white p-8 shadow-sm lg:p-12">
            ...
            <div className="rounded-[1.75rem] border border-[#d9d9d6] p-6 md:p-8">
              <ul className="space-y-6">
                {portfolioItems.map((item, index) => (
                  <li key={index} className="flex gap-4">
                    <div className="mt-2 h-2.5 w-2.5 shrink-0 rounded-full bg-[#8d8d88]" />
