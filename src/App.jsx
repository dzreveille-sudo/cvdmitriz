...
useEffect(() => {
  ...
  const experiences = [
    {
      period: "2020 — Настоящий момент",
      role: "Специалист по коммуникации",
      company: "Мэрия Москвы",
      description: "Занимаюсь продвижением проектов мэрии Москвы. Готовлю тезисы, пресс-релизы, статьи для СМИ, посты для соцсетей, тексты для медиаэкранов. Делаю выжимки с Reddit и X, переводы с английского. Курирую освещение программы «Мой район», участвую в сопровождении выборов, помогаю в выпуске окружной газеты.",
    },
    {
      period: "2018 — 2020",
